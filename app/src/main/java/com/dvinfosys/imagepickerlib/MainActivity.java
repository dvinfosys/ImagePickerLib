package com.dvinfosys.imagepickerlib;
...
import com.dvinfosys.imagepicker.model.SavePath;
import com.dvinfosys.imagepicker.ui.imagepicker.ImagePicker;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void launchFragment() {
        ...
        config.setDoneTitle(getString(com.dvinfosys.imagepicker.R.string.imagepicker_action_done));
        config.setFolderTitle(getString(com.dvinfosys.imagepicker.R.string.imagepicker_title_folder));
        config.setImageTitle(getString(com.dvinfosys.imagepicker.R.string.imagepicker_title_image));
